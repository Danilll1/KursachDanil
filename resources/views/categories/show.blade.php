        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <ul class="social-links" style="list-style-type: none; padding: 0; text-align: right;">
                    ...
                    <li style="font-size: 18px;"><a href="#"><i class="fab fa-instagram"></i> Instagram</a></li>
                    <li style="font-size: 18px;"><a href="#"><i class="fab fa-facebook-f"></i> Facebook</a></li>
                    <li style="font-size: 18px;"><a href="#"><i class="fab fa-twitter"></i> Twitter</a></li>
                </ul>
            </div>
        </div>
